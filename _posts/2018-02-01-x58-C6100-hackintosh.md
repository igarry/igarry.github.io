...
1. **安装Nvidia显卡驱动 **[^3]
   ...
   5. 左边菜单选中**System Parameters**，在右边勾选**NvidiaWeb**
      <figure style="width: 475px"  class="align-center">
      <img src="http://wx1.sinaimg.cn/large/6da9d54cly1fo12g5ubt6j21kw0uq12k.jpg" alt="">
      </figure> 
   6. 重启再次进入系统，显卡正常工作
...
[^5]: 转存自 https://itunes.apple.com/cn/app/macos-high-sierra/id1246284741?mt=12
[^6]: 转存自[MultiBeast - High Sierra 10.2.0](https://www.tonymacx86.com/resources/multibeast-high-sierra-10-2-0.360/)
[^7]: 转存自 http://mackie100projects.altervista.org/download-clover-configurator/
